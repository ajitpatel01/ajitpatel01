#!/usr/bin/env python3
"""
Alternate heatmap renderer via github-contributions-api (fallback if scrape fails).
...
DEFAULT_USER = "ajitpatel01"
if os.path.exists(PROFILE_PATH):
    with open(PROFILE_PATH) as f:
        DEFAULT_USER = yaml.safe_load(f).get("heatmap", {}).get("github_user", DEFAULT_USER)
