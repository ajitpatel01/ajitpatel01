...
INP = sys.argv[1] if len(sys.argv) > 1 else os.path.join(ROOT, "assets", "source-photo.png")
OUT = sys.argv[2] if len(sys.argv) > 2 else os.path.join(ROOT, "assets", "source-prepped.png")
